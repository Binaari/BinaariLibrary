 ...
 * 
 * !!! Derived from SparkFunBME280 library !!!
 * 
 * Driver for controlling the BME280 Environmental 
 * sensor. It initializes the sensor and offers functions
 * for reading essential information from the sensor.
 * 
 * Author:        Tuukka Panula
 * 
 * Release date:  27/6/2017 (dd/mm/yyyy)
 * 
...
EnvironmentalSensor::EnvironmentalSensor( void )
{
...
//
//****************************************************************************//
uint8_t EnvironmentalSensor::init()
{
...
//Strictly resets.  Run .init() afterwards
void EnvironmentalSensor::reset( void )
{
...
//
//****************************************************************************//
float EnvironmentalSensor::readPressure( void )
{
...
float EnvironmentalSensor::readAltitude( void )
{
...
//
//****************************************************************************//
float EnvironmentalSensor::readHumidity( void )
{
...
float EnvironmentalSensor::readTemperature( void )
{
...
//
//****************************************************************************//
void EnvironmentalSensor::readRegisterRegion(uint8_t *outputPointer , uint8_t offset, uint8_t length)
{
...
uint8_t EnvironmentalSensor::readRegister(uint8_t offset)
{
    //Return value
    uint8_t result;
    uint8_t numBytes = 1;
...
int16_t EnvironmentalSensor::readRegisterInt16( uint8_t offset )
{
    uint8_t myBuffer[2];
...
void EnvironmentalSensor::writeRegister(uint8_t offset, uint8_t dataToWrite)
{
    //Write the byte
    Wire.beginTransmission(settings.I2CAddress);
    Wire.write(offset);
